...
**Status:** v0.3.0. Tested against WordPress 6.6+ / WooCommerce 10.7 / OpenSalesTax engine v0.36. 69 unit tests + an end-to-end integration test on a real WP+WooCom Proxmox VM.
...
- **Status dashboard widget** showing engine reachability + cache hit rate (v0.3.1)
- **Recent-calculations debug log** with admin viewer (v0.3.2)
